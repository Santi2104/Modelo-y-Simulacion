...
document.getElementById("ejecutarCola").addEventListener('click', function(e) {
    ...
    pintarTabla(convertir(tiempo), convertir(proxLlegada), convertir(proxFinServicio), convertir(proxSalidaZS), ZS, q, ps)
    ...
    function pintarTabla(tiempo, proxLlegada, proxFinServicio, proxSalidaZS, ZS, q, ps) {
